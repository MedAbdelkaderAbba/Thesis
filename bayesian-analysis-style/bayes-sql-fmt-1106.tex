...
Bayesian $\sqrt{\text{Lasso}}$ and \sqdl{}\thanksref{T1}}
\runtitle{Heavy Tails and Sparsity}
\thankstext{T1}{Footnote to the title with the ``thankstext'' command.}

\begin{aug}
\author{\fnms{Mohamed Abdelkader} \snm{Abba}\thanksref{addr1,t1,t2,m1}\ead[label=e1]{mabba@ncsu.edu}},
...
%\subsection{Sparse Normal Means}
%
...
%\subsection{High Dimensional Regression} A canonical problem is high dimensional regression and particularly model selection. In this section we generate our data following the linear regression model:
